...
const routes_config = [
    ...
    {path:'/eng4900',label:'Eng 4900',component:Eng4900,tab:true,routes:[
        {path:'/eng4900/view/:id',label:'Eng 4900',component:Eng4900,tab:false},
        {path:'/eng4900/edit/:id',label:'Eng 4900',component:Eng4900,tab:false},
    ]},
...
const routes_tabs = routes_config.map(route => 
