...
export const routes_config = [
    ...
    {path:'/hra',label:'HRA Supervisor',alias:'hra',component:Hra,icon:<SupervisorAccountIcon/>,tab:true,level:'user',type:'private'},
    {path:'/employee',alias:'employee',label:'Employee',component:Employee,icon:<BadgeIcon/>,tab:true,level:'user',type:'private'},
    {path:'/eng4900',alias:'eng4900',label:'Supervisor Forms - Eng 4900',component:Eng4900,icon:<DescriptionIcon/>,tab:true,level:'admin',type:'private'},
