...
function Equipment({history, location, match, userToken}) {
  ...
  const equipmentTabs = {0: {id:'my_equipment', label:'My Equipment'}, 1: {id:'my_hra_equipment', label:'My HRA Equipment'}, 2: {id:'hra_equipment', label:'Authorized HRA Equipment'}, 3: {id:'equipment_search', label:'Equipment Search'}}
