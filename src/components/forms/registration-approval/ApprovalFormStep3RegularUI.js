...
const ApprovalFormStep3RegularUI = (props) => {
    ...
    return(
        <div style={{display:'flex',flexDirection:'column'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',padding:'1em',backgroundColor:bColor.rgb245,height:'34em'}}>
                <Box
                onClick={()=>{setActionTab(actionTab === 1 ? 0:1)}}
                className={selEmpClasses.root}
                // className="assign-registration-paper"
            ...
            <div style={{display:'flex',justifyContent:executed ? 'flex-end':'space-between',padding:'1em',paddingTop:'1em',backgroundColor:bColor.rgb245}}>
