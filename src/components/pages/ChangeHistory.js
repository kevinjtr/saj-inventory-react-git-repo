		...
		if(changeHistory[tab_idx].length > 0){
			...
			let cols_config = 
			{
				0: 	[//equipment
					...
					{ title:'Condition',field:'condition_name', editable: 'never'},
				...
				1: [//employee
					...
					{ title: 'Division',field:'division_symbol',editable: 'onAdd', exportColumn: 'division_symbol',  editable: 'never'},
					{ title: 'District',field:'district_symbol',editable: 'onAdd', exportColumn: 'district_symbol',  editable: 'never'},
					{ title: 'Equipment Quantity',field:'employee_equipment_count',editable: 'never'},
					{ title: 'Deleted', field: 'deleted', editable: 'never', type:'boolean'},
					{ title: 'Office Location Name',field:'office_location_name',editable: 'never'},
					{ title:'Updated By',field:'updated_by_full_name',editable:'never' }
				],
				2: [//hra
					{ title: 'Updated Date', field: 'updated_date', editable: 'never', type:'date'},
					{ title: 'HRA Number', field: 'hra_num', editable: 'never', type:'numeric'},
					{ title: 'Certification Date', field: 'certification_date', editable: 'never', type:'date'},
